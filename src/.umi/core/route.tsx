...
export async function getRoutes() {
  const routes = {"about/index":{"path":"about","id":"about/index","parentId":"@@/global-layout"},"index":{"path":"/","id":"index","parentId":"@@/global-layout"},"docs":{"path":"docs","id":"docs","parentId":"@@/global-layout"},"@@/global-layout":{"id":"@@/global-layout","path":"/","isLayout":true}} as const;
  return {
    routes,
    routeComponents: {
...
'@@/global-layout': React.lazy(() => import(/* webpackChunkName: "layouts__index" */'/Users/wangshengjin/Documents/workspace/myself/website/src/layouts/index.tsx')),
},
  };
}
